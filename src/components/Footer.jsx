...
const Footer = () => {
  ...
  return (
    <footer>
        ...
        <div className="mt-20 mb-10 flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="text-Black">
            ...
            <div className="space-y-2">
              <Link to="/jewelry" className="text-sm block hover:text-orange-500">
              Jewelry & Accessories
              </Link>
              <Link to="/clothing" className="text-sm block hover:text-orange-500">
              Clothing & Shoes
              </Link>
              <Link to="/homeliving" className="text-sm block hover:text-orange-500">
              Home & Living
              </Link>
              <Link to="/weddingParty" className="text-sm block hover:text-orange-500">
              Wedding & Party
              </Link>
              <Link to="/toysEntertainment" className="text-sm block hover:text-orange-500">
              Toys & Entertainment
              </Link>
            </div>
          </div>
      ...
      <p className="text-white text-center items-center py-3">© {currentYear} Ecom, Inc.</p>
      </div>
    </footer>
  );
};
